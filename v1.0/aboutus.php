...
?>
    <div class = "container-fluid">
      ...
      <div class="jumbotron text-center">
        <h1>About Us</h1>
        <p>Innovators changing the world one step at a time!</p>
      </div>
    </div>

		<!-- Mission Statemet and Introduction -->
    <div class="container-fluid intro">
      <h1>Our Mission Statement </h1>
      <div class="content">
      <p>We are a group of web developers aiming to tackle the global issue of food waste.  Our goal was to create a web application that would allow us to bring communities together to reduce the amount of annual food waste. </p>
      <p>We define a community as people you interact closely with on a daily basis including at home, in the office, and student dormitories. Food waste is
        reduced by having our users share leftover food in a fridge with other registered members in a close community.</p>
      <p>We honestly strive and hope those like-minded people will use our app and work with us in accomplishing our
        vision on environmental sustainability through food waste reduction.
      </p>
      </div>
    </div>
